  ...
  void _continue() {
    ...
    if (selectedDate == null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Ride details saved!"),
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("Schedule your ride", style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w500)),
                          Padding(
                            ...
                            child: GlobalOutlineEditText(
                              hintText: selectedDate != null
                                  ...
                                  : "Select Date",
                              editable: false,
                              suffixIcon: Image.asset("assets/icons/ic_calendar.png", width: screenWidth * 0.022, height: screenHeight * 0.02),
                              suffixIconSize: 22,
                              onTap: () => _openDatePicker(context),
                            ),
                          ),
                          const SizedBox(height: 16),
                          Text("Pickup Time", style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w500)),
                          Padding(
                            padding: const EdgeInsets.only(top: 8.0),
                            child: Row(
                              children: [
                                Expanded(child: _timeInput("Hrs", (val) => selectedHour = val)),
                                const SizedBox(width: 10),
                                Expanded(child: _timeInput("Min", (val) => selectedMinute = val)),
                                const SizedBox(width: 10),
                                Expanded(
                                  child: Row(
                          ...
                          const SizedBox(height: 16),
                          Text("Select your Vehicle", style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w500)),
                          ...
                          Wrap(
                            ...
                            children: vehicles.map((vehicle) {
                              ...
                              return ChoiceChip(
                                backgroundColor: isSelected ? null : AppColors.gray002,
                                label: Text(vehicle),
                                selected: isSelected,
                                onSelected: (_) => setState(() => selectedVehicle = vehicle),
                              );
                            }).toList(),
                          ),
